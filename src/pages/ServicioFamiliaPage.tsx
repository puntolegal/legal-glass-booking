...
export default function ServicioFamiliaPage() {
    ...
    return (
      <>
        ...
        {/* Botón Móvil Flotante - CRO Optimización */}
        <motion.button
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.5 }}
          onClick={() => setShowQuiz(true)}
          className="md:hidden fixed bottom-0 left-0 right-0 z-50 w-full py-4 px-6 bg-gradient-to-r from-pink-500 to-rose-600 text-white font-bold text-lg shadow-2xl shadow-pink-500/40 pb-safe"
        >
          Empezar Quiz Gratis
        </motion.button>

  ...
  return (
    <>
      <div className="lg:hidden">
        <AppSidebar onAgendarClick={onAgendarClick} />
      </div>
      
      <header className="fixed top-0 w-full z-50 glass backdrop-blur-xl bg-background/90">
        <div className="px-4 py-3 md:py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="lg:hidden">
                <SidebarTrigger className="w-10 h-10 rounded-xl border border-border/50 backdrop-blur-sm glass bg-background/20 text-foreground hover:bg-primary/10 hover:border-primary/30 hover:text-primary transition-all duration-200" />
              </div>

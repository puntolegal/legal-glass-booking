...
/**
 * Script para probar el sistema con el dominio final puntolegal.online
 */

console.log('🧪 PROBANDO SISTEMA CON DOMINIO FINAL');
console.log('=====================================\n');

const RESEND_API_KEY = 're_gvt6L3ER_5JiDjxtbkT1UpYowirF24DFW';
const FROM_EMAIL = 'Punto Legal <team@puntolegal.online>';
const CLIENT_EMAIL = 'benja.soza@gmail.com';
const ADMIN_EMAIL = 'puntolegalelgolf@gmail.com';

async function testFinalDomain() {
  try {
    console.log('📧 Enviando emails con dominio final...');
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
              ...
              <div style="background: white; padding: 20px; margin: 20px 0; border-radius: 8px; border-left: 4px solid #667eea;">
                ...
                <p style="margin: 8px 0;"><strong>ID Reserva:</strong> test-final-${Date.now()}</p>
              </div>
              ...
              <div style="background: white; padding: 20px; margin: 20px 0; border-radius: 8px; border-left: 4px solid #28a745;">
                ...
                <p style="margin: 8px 0;"><strong>Email:</strong> team@puntolegal.online</p>
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
              ...
              <div style="background: white; padding: 20px; margin: 20px 0; border-radius: 8px; border-left: 4px solid #28a745;">
                ...
                <p style="margin: 8px 0;"><strong>ID:</strong> test-final-${Date.now()}</p>
                <p style="margin: 8px 0;"><strong>Servicio:</strong> Consulta General</p>
    ...
    if (clientResponse.ok && adminResponse.ok) {
      ...
      console.log('===============================');
      console.log('• Dominio puntolegal.online verificado');
      console.log('• Emails enviados a cualquier dirección');
      console.log('• Sistema listo para producción');
      console.log('');
      console.log('📋 CONFIGURAR SUPABASE:');
      console.log('=======================');
      console.log('MAIL_FROM = Punto Legal <team@puntolegal.online>');
      console.log('');
      console.log('🧪 PROBAR APLICACIÓN COMPLETA:');
      console.log('==============================');
      console.log('1. Ir a /agendamiento?plan=general');
      console.log('2. Completar formulario');
      console.log('3. Proceder al pago');
      console.log('4. Verificar emails automáticos');
    }

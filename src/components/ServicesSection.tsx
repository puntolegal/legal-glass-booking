...
const internalServices: InternalService[] = [
  // ========== PERSONAS ==========
  {
    ...
    shortName: "Laboral",
    hook: "Despido, tutela laboral o Ley 21.643 (Ley Karin): priorizamos tu caso y te decimos la vía con plan por escrito.",
    descriptionHtml:
      "Evaluamos <strong>despido injustificado, finiquito, nulidad y acoso laboral</strong> (incl. Ley Karin). Sesión de 45 minutos por Google Meet; si el patrocinio es a porcentaje, pagas honorarios sólo cuando recuperas, según acuerdo escrito.",
    ...
    icon: Scale,
    features: [
      "Evaluación de despido, finiquito y tutela",
    ...
    clusterPills: [
      { label: "Consulta laboral", plan: "tutela-laboral" },

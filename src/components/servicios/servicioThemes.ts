...
export const SERVICIO_THEMES: Record<ServicioThemeId, ServicioThemeTokens> = {
  ...
  laboral: {
    id: 'laboral',
    radialTL: 'from-amber-500/7',
    radialBR: 'from-sky-500/5',
    chip: 'border border-amber-400/25 bg-amber-500/8 text-amber-100',
    accent: 'text-amber-400',
    accentStrong: 'text-amber-300',
    accentBg: 'bg-amber-500',
    accentBgHover: 'hover:bg-amber-600',
    accentBorder: 'border-amber-500/25',
    accentBorderStrong: 'border-amber-400/45',
    accentGlow: 'from-amber-500/15 to-sky-500/8',
    stat: 'text-amber-400',
    dot: 'bg-amber-400',
    pillSuccess: 'bg-emerald-500/10 border-emerald-500/30',
    pillSuccessText: 'text-emerald-300',
    cardPopularRing: 'border-2 border-amber-400/45',
    link: 'text-amber-400',
    linkHover: 'hover:text-amber-300',
    btnPrimary:
      'bg-gradient-to-r from-amber-500 to-amber-600 text-slate-950 shadow-lg shadow-amber-900/30',
    btnPrimaryHover: 'hover:from-amber-400 hover:to-amber-500',
    btnOutline: 'border border-white/15 bg-white/5 backdrop-blur-xl text-slate-200',
    btnOutlineHover: 'hover:bg-white/10',
    sectionWash: 'bg-slate-900/50 border-y border-slate-800/60',
    iconBox: 'bg-gradient-to-br from-amber-500/25 to-amber-500/5',

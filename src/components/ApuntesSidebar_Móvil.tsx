...
const ApuntesSidebar: React.FC<ApuntesSidebarProps> = ({
  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-400/8 dark:bg-indigo-500/4 rounded-full blur-xl" />
  ...
  return (
          ...
          <button onClick={onToggle} className="lg:hidden p-2 -mr-2 text-gray-500 hover:text-gray-800 dark:hover:text-gray-200">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        >
          <div className="backdrop-blur-xl bg-white/10 dark:bg-white/5 rounded-2xl p-4 border border-white/20 dark:border-white/10 shadow-lg">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center gap-2">
                <FilterIcon className="w-4 h-4 text-indigo-500 dark:text-indigo-400" />
                Filtros
              </h3>
              <button
                ...
                >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full p-3 backdrop-blur-xl bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500/30 text-gray-900 dark:text-white text-sm transition-all duration-300"
                    >
          ...
          <div className="backdrop-blur-xl bg-white/10 dark:bg-white/5 rounded-2xl p-4 border border-white/20 dark:border-white/10 shadow-lg">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex-1 p-3 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 text-sm font-medium border ${
                  viewMode === 'grid' 
                    ? 'bg-blue-500 border-blue-500 text-white shadow-lg shadow-blue-500/30' 
                    : 'bg-white/10 dark:bg-white/5 text-gray-600 dark:text-gray-400 hover:bg-white/20 dark:hover:bg-white/10 border-white/10'
                }`}
              >
        ...
        >
          <div className="backdrop-blur-xl bg-white/10 dark:bg-white/5 rounded-2xl p-4 border border-white/20 dark:border-white/10 shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              ...
              <div className="p-3 bg-white/5 dark:bg-white/5 rounded-lg border border-white/10 text-center">
                <div className="flex items-center justify-center gap-1 text-lg font-bold text-indigo-600 dark:text-indigo-400">
              ...
              {showStats && (
                ...
                >
                  <div className="text-xs text-gray-600 dark:text-gray-400">
                    ...
                    <div className="flex justify-between items-center py-1">
                      <span>Medallas:</span>
                      <span className="font-medium text-indigo-600 dark:text-indigo-400">{progress.medals.length}</span>
                    </div>
                  </div>
                </motion.div>
              )}
        ...
        >
          <div className="backdrop-blur-xl bg-indigo-500/10 dark:bg-indigo-500/5 rounded-2xl p-4 border border-white/20 dark:border-white/10 text-center">
  ...
  return (
    <>
      {/* Versión de escritorio: Fija */}
      <aside className="hidden lg:block w-80 h-screen fixed left-0 top-0 z-30 backdrop-blur-2xl bg-gradient-to-b from-white/20 via-white/10 to-white/5 dark:from-slate-900/20 dark:via-slate-900/10 dark:to-slate-900/5 border-r border-white/20 dark:border-white/10 overflow-hidden">
        <SidebarContent />
      </aside>

      {/* Versión móvil: Overlay deslizable */}
      <AnimatePresence>
        {isOpen && (
          <>
            {/* Backdrop */}
            ...
            <motion.aside
              ...
              className="fixed top-0 left-0 h-full w-80 max-w-[85vw] z-50 bg-slate-100 dark:bg-slate-900 border-r border-white/20 dark:border-white/10 overflow-hidden"
            >
              <SidebarContent />
            </motion.aside>
          </>
